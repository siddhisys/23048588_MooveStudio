...
public class MooveApp extends javax.swing.JFrame {
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        String skillLevel = comboSkill.getSelectedItem().toString();
        ...
        if (serialNo.isEmpty() || className.isEmpty() || startTime.isEmpty() || age.isEmpty()
            ...
            JOptionPane.showMessageDialog(this, "All fields are required. Please fill in all details.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (!ValidationUtil.isValidSerialNo(serialNo)) {
            JOptionPane.showMessageDialog(this, "Invalid Serial Number. It must contain only digits.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return;

        }
        if (!ValidationUtil.isValidAge(age)) {
            JOptionPane.showMessageDialog(this, "Invalid Age. Age can only be numbers.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (!ValidationUtil.isValidTime(startTime) || !ValidationUtil.isValidTime(endTime)) {
            JOptionPane.showMessageDialog(this, "Invalid Time format. Please use the 12-hour format (e.g., 01:00 PM).", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return;
    ...
    private void updatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatebtnActionPerformed
        ...
        if (serialNo.isEmpty() && newStartTime.isEmpty() && newEndTime.isEmpty()) {
            JOptionPane.showMessageDialog(this, "All fields are required. Please fill in the details.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        // Check if some fields are missing
        if (serialNo.isEmpty() || newStartTime.isEmpty() || newEndTime.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Incomplete details provided. Please fill in all required fields.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        // Get the table model
        DefaultTableModel model = (DefaultTableModel) tblSchedule.getModel();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (searchKey.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please enter a serial number to search.", "Input Error", javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Invalid serial number. Please enter a valid integer.", "Input Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        // Step 6: Display results in a dialog box
        if (searchedData != null) {
            String message = String.format(
                    "Class Found:\nSerial No: %d\nClass Name: %s\nStart Time: %s\nEnd Time: %s\nSkill Level: %s\nAge Group: %s\nTotal Students: %d\nInstructor: %s",
                    searchedData.getSerialNo(),
                    searchedData.getClassName(),
                    searchedData.getStartTime(),
                    searchedData.getEndTime(),
                    searchedData.getSkillLevel(),
                    searchedData.getAge(),
                    searchedData.getTotalStudents(),
                    searchedData.getInstructor()
            );
            javax.swing.JOptionPane.showMessageDialog(this, message, "Search Result", javax.swing.JOptionPane.INFORMATION_MESSAGE);
        } else {
            javax.swing.JOptionPane.showMessageDialog(this, "Sorry, serial number not found.", "Search Result", javax.swing.JOptionPane.WARNING_MESSAGE);
        }
    ...
    // Add this method to set up the action for the combo box
    private void setupComboBoxListener() {
        comboClassName.addItemListener((java.awt.event.ItemEvent evt) -> {
            if (evt.getStateChange() == java.awt.event.ItemEvent.SELECTED) {
                String selectedClass = comboClassName.getSelectedItem().toString();
